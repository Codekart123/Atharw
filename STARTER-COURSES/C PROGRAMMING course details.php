                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/C programming.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN C PROGRAMMING LANGUGAE</h3>
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>C is a general-purpose, procedural computer programming language supporting structured
                                programming, lexical variable
                                scope, and recursion, with a static type system. By design, C provides constructs that
                                map efficiently to typical

...
<head>
    <title>BASIC WEB TECH | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/HTML CSS JS.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN BASIC WEB TECHNOLOGY</h3>
                        ...
                        <div class="portfolio-description">
                            <h2>What is Basic Web Technology ?</h2>
                            <p>It is the web server's job to give the web browser the relevant HTML, CSS and JavaScript
                                code that it needs in order to
                                display an interactive web page. ... It is the web browsers job to interpret these
                                languages in order to display a web
                                page properly.
                            </p>
                        </div>
                        <a href="../Syllabus/Starter/Certification in Basic Web Technology .pdf" target="_blank">

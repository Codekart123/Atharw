...
<head>
    <title>CORE PYTHON | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/python.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN CORE PYTHON</h3>
                        ...
                        <div class="portfolio-description">
                            <h2>What is Core Python ?</h2>
                            <p>Python is an interpreted, high-level, general-purpose programming language that
                                emphasizes code readability. It's a
                                dynamically typed and garbage-collected language that supports structured,
                                object-oriented, and functional programming.
                            </p>
                        </div>
                        <a href="../Syllabus/Starter/Certification in Core Python Programming Language.pdf" target="_blank">

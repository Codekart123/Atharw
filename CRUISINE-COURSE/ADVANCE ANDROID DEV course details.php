...
<head>
    <title>ADVANCE ANDROID | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/android.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>Android software development is the process by which applications are created for devices
                                ...
                                software development kit, while using other languages is also possible.
                            </p>
                        </div>
                        <a href="../Syllabus/Cruisin/Certification in Advance Android.pdf" target="_blank">

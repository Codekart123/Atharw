...
<head>
    <title>SOFTWARE TESTING | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/sellenium.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>SOFTWARE AUTOMATION TESTING
                                WITH SELLENIUM</h3>
                        ...
                        <div class="portfolio-description">
                            <h2>What is SELLENIUM ?</h2>
                            <p>Selenium is a portable framework for testing web applications. Selenium provides a
                                playback tool for authoring
                                functional tests without the need to learn a test scripting language.
                            </p>
                        </div>
                        <a href="../Syllabus/Cruisin/Software Testing.pdf" target="_blank">

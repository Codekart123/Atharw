...
<head>
    <title>PYTHON | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/core&advance PYTHON.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN PYTHON PROGRAMMING LANGUAGE</h3>
                        ...
                        <a href="../Syllabus/Cruisin/Certification in Python Programming Language.pdf" target="_blank">

...
<head>
    <title>DATA VISUALIZATION | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/DATA VISUALIZATION.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN DATA VISUALIZATION WITH PYTHON</h3>
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>Data visualization is the graphical representation of information and data. By using
                                visual elements like charts,
                                graphs, and maps, data visualization tools provide an accessible way to see and
                                understand trends, outliers, and
                                patterns in data.
                            </p>
                        </div>
                        <a href="../Syllabus/Main Course/Data visualization with Python.pdf" target="_blank">

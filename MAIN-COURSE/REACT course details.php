...
<head>
    <title>REACT | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/REACT.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>WEB DEVELOPEMENT IN REACT</h3>
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>React is an open-source, front end, JavaScript library for building user interfaces or UI
                                components. It is maintained
                                by Facebook and a community of individual developers and companies. React can be used as
                                a base in the development of
                                single-page or mobile applications
                            </p>
                        </div>
                        <a href="../Syllabus/Main Course/Web Development in React.pdf" target="_blank">

...
<head>
    <title>DJANGO | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/DJANGO.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>WEB DEVELOPEMENT IN PYTHON WITH DJANGO</h3>
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>Django is an open-source python web framework used for rapid development, pragmatic,
                                maintainable, clean design, and
                                secures websites. A web application framework is a toolkit of all components need for
                                application development.
                            </p>
                        </div>
                        <a href="../Syllabus/Main Course/Web Development in Python with Django.pdf" target="_blank">

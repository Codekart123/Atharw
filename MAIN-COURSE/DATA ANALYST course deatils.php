...
<head>
    <title>DATA ANALYST | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/DATA ANALYTICS.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN DATA ANALYSIS</h3>
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>Data analysis is a process of inspecting, cleansing, transforming, and modeling data with
                                the goal of discovering useful
                                information, informing conclusions, and supporting decision-making.
                            </p>
                        </div>
                        <a href="../Syllabus/Main Course/Certification on Data Analyst  .pdf" target="_blank">

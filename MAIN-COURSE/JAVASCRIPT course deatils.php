...
<head>
    <title>JAVASCRIPT | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/JS2.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN JAVASCRIPT</h3>
                        ...
                        <a href="../Syllabus/Main Course/Certification in Java Script.pdf" target="_blank">

...
<head>
    <title>ANGULAR | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/ANGULAR.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>WEB DEVELOPEMENT IN ANGULAR</h3>
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>Angular is a TypeScript-based open-source web application framework led by the Angular
                                Team at Google and by a community
                                of individuals and corporations. Angular is a complete rewrite from the same team that
                                built AngularJS.
                            </p>
                        </div>
                        <a href="../Syllabus/Main Course/Web Development in Angular.pdf" target="_blank">

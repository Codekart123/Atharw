...
<head>
    <title>HIBERNATE | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/HIBERNATE.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN HIBERNATE</h3>
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>Hibernate ORM is an object–relational mapping tool for the Java programming language. It
                                provides a framework for
                                mapping an object-oriented domain model to a relational database.
                            </p>
                        </div>
                        <a href="../Syllabus/Main Course/Certification in Hibernate.pdf" target="_blank">

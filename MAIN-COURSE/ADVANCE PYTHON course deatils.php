...
<head>
    <title>ADVANCE PYTHON | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/ADVANCE PYTHON.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN ADVANCE PYTHON</h3>
                        ...
                        <div class="portfolio-description">
                            <h2>What is Advance Python ?</h2>
                            <p>Python is a programming language known for its code readability and use of whitespace for
                                user-friendly design, making
                                it easier to use the purpose of coding. Its approach aims to help programmers write
                                clear, logical code for large-scale
                                projects. So when you are able to deliver a product with python, to address a real-world
                                problem is called as
                            </p>
                        </div>
                        <a href="../Syllabus/Main Course/Certification in Advance Python Programming Language.pdf" target="_blank">

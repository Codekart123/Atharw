...
<head>
    <title>PHP | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/PHP MYSQL.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        ...
                        <div class="portfolio-description">
                            ...
                            <p>
                                ...
                                Danish-Canadian programmer Rasmus Lerdorf in 1994. The PHP reference implementation is
                                now produced by The PHP Group.
                            </p>
                        </div>
                        <a href="../Syllabus/Main Course/Web Development in PHP.pdf" target="_blank">

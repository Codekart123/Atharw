...
<head>
    <title>PYTHON & SQL | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
            ...
            <div class="row gy-4">
                    ...
                    <div class="portfolio-details-slider swiper-container">
                        <div class="swiper-wrapper align-items-center">
                            ...
                            <div class="swiper-slide">
                                <img src="../assets/img/course/PYTHON SQL DS.png" alt="">
                            </div>
                        </div>
                ...
                <div class="col-lg-4">
                    <div class="portfolio-info">
                        <h3>PYTHON WITH SQL FOR DATA SCIENCE</h3>
                    ...
                    <div class="portfolio-description">
                        <h2>What is Python with sql ?</h2>
                        <p>Python supports various databases like SQLite, MySQL, Oracle, Sybase, PostgreSQL, etc.
                            ... Python also supports Data
                            Definition Language (DDL), Data Manipulation Language (DML) and Data Query Statements.
                            The Python standard for database
                            interfaces is the Python DB-API.
                        </p>
                    </div>
                    <a href="../Syllabus/Main Course/Python and SQL For Data Science.pdf" target="_blank">

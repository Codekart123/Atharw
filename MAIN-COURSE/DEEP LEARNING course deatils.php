...
<head>
    <title>DEEP LEARNING | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/DEEP LEARNING.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>CERTIFICATION IN DEEP LEARNING</h3>
                        ...
                        <a href="../Syllabus/Main Course/Deep Learning.pdf" target="_blank">

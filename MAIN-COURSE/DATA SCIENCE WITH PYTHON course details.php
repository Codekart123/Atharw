...
<head>
    <title>DATA SCIENCE | COURSES | ATHARW </title>
    <!-- header links -->
    <?php
                ...
                <div class="row gy-4">
                        ...
                        <div class="portfolio-details-slider swiper-container">
                            <div class="swiper-wrapper align-items-center">
                                ...
                                <div class="swiper-slide">
                                    <img src="../assets/img/course/PYTHON DATASCIENCE.png" alt="">
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4">
                        <div class="portfolio-info">
                            <h3>PROGRAMMING FOR DATA SCIENCE WITH PYTHON</h3>
                        ...
                        <a href="../Syllabus/Main Course/Programming for Data Science with Python.pdf" target="_blank">
